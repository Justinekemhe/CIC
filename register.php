...
<div class="phpdarkcoding">
    <section class="headeroption">
        <h2>KNOWLEDGE REPACKAGING</h2>
    </section>

    <section class="mainoption">
        <h1 class="success">Registration Form</h1>
        <hr/>
        <div class="contentoption">
            <div class="member_addition">
                ...
                <form action="" method="post">
                    ...
                    <input type="password" name="password"  placeholder="Enter Password" class="insert" ><br/>
                    ...
                    <input type="submit" value="Register" name="addmember" class="save_member_btn"><br/>
